package fr.breaker.caveupdate.features;
...
public class MyFeatures extends StructureFeature<DefaultFeatureConfig> {
    public MyFeatures(Codec<DefaultFeatureConfig> codec) {
        super(codec);
    }
